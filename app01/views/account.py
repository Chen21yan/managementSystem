...
def login(request):
    ...
    if form.is_valid():
        # 验证成功，获取到的用户名和密码
        # {'username': 'alisa', 'password': '123',"code":123}
        # {'username': 'alisa', 'password': '5e5c3bad7eb35cba3638e145c830c35f',"code":xxx}
...
def logout(request):
    ...
    request.session.clear()  # 清除当前用户session
